...
const formatMessageToTelegram = async (parsedJson, affiliateLink) => {
	try {
		...
		console.error("Erro ao formatar a mensagem para o telegram:", error);
		return "";
	}
};

module.exports = { formatMessageToTelegram };
